...
export default function CheckoutBundle({ bundle, hasAccess, pendingInvoice, pendingInvoiceUrl, referralInfo }: CheckoutBundleProps) {
    ...
    const submitPayment = async (): Promise<void> => {
        const activeDiscountAmount = discountData?.valid ? discountData.discount_amount : 0;
                                        ...
                                        <div className="space-y-2 rounded-xl bg-gray-50/50 p-4 border border-gray-100 text-sm">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-lg font-bold text-[#FA5F25]">
                                                    Rp {(pendingInvoice?.amount || bundle.price + transactionFee).toLocaleString('id-ID')}
                                                </span>
                                            </div>
                                        </div>
