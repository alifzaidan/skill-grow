...
import PopularClassSection from './popular-class-section';
...
export default function Home({ allProducts }: HomeProps) {
    return (
        <UserLayout>
            ...
            <a
                href="https://wa.me/+6285184012430?text=Halo%20Admin%20Skillgrow,%20saya%20ingin%20bertanya%20tentang%20kelas%20online."
                target="_blank"
